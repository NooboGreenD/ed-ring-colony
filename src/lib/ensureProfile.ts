...
export async function ensureUserProfile(supabase: SupabaseClient, user: User, body: EnsureProfileBody = {}) {
  ...
  if (error) {
    ...
    return { ok: false, created: false } as const;
  }
