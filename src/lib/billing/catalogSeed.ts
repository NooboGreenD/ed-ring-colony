...
export const INITIAL_SHOP_ITEMS: ShopItem[] = [
  ...
  // ── HUD Skins ──
  {
    ...
    preview_data: {
      ...
      theme: { bg: '#1f1a14', panel: '#2b241b', panelHover: '#352c21', line: '#4a3b28', text: '#f5ecdc', muted: '#b7a58a', orange: '#f59e0b', orangeHover: '#fbbf24', cyan: '#d97706', effect: 'vignette', background: 'radial-gradient(ellipse at top, #2a2116 0%, #1f1a14 60%)' },
    },
    is_active: true,
    is_featured: false,
    sales_count: 0,
  ...
  },
  {
    ...
    preview_data: {
      ...
      theme: { bg: '#0b0714', panel: '#160f24', panelHover: '#1f1533', line: '#3b2a5c', text: '#f4e9ff', muted: '#a78bda', orange: '#ec4899', orangeHover: '#f472b6', cyan: '#06b6d4', green: '#22d3ee', effect: 'scanlines', background: 'linear-gradient(180deg, #0b0714 0%, #12091f 100%)' },
    },
    is_active: true,
    is_featured: true,
    sales_count: 0,
  ...
  },
  {
    ...
    preview_data: {
      ...
      theme: { bg: '#0a0f1e', panel: '#111a2e', panelHover: '#182440', line: '#243456', text: '#e6edff', muted: '#8fa3c7', orange: '#3b82f6', orangeHover: '#60a5fa', cyan: '#93c5fd', effect: 'stars', background: 'radial-gradient(ellipse at bottom, #101a33 0%, #0a0f1e 70%)' },
    },
    is_active: true,
    is_featured: false,
    sales_count: 0,
  ...
  },
  {
    ...
    preview_data: {
      ...
      theme: { bg: '#0d0c0a', panel: '#171512', panelHover: '#201d18', line: '#3d3424', text: '#f7f1e1', muted: '#b6a98c', orange: '#eab308', orangeHover: '#facc15', cyan: '#fef08a', effect: 'glow', background: 'radial-gradient(ellipse at top, #1a1710 0%, #0d0c0a 65%)' },
    },
    is_active: true,
    is_featured: true,
    sales_count: 0,
  ...
  },
  {
    ...
    preview_data: {
      ...
      theme: { bg: '#0b1410', panel: '#122019', panelHover: '#182a21', line: '#23443a', text: '#e7f7ef', muted: '#8fbaa6', orange: '#10b981', orangeHover: '#34d399', cyan: '#34d399', effect: 'grid', font: "'JetBrains Mono', 'Fira Code', ui-monospace, monospace" },
    },
    is_active: true,
    is_featured: false,
    sales_count: 0,
