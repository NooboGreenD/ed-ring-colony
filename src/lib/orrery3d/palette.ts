 ...
 *
 * Один источник цвета и подписей для 3D-сцены, боковой панели сайта и
 * автономного HTML из Colonial Helper: раньше цвета жили в трёх местах
 * (plotly_map.py, SystemPlotlyMap.tsx, Tk-холст) и расходились.
 */
