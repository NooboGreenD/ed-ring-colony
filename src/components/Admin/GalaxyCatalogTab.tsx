          ...
          <div style={{ color: '#ef4444', fontSize: 13, marginBottom: 8 }}>
            ...
            {/statement timeout|57014/i.test(state.error) && (
              <div style={{ marginTop: 6, color: '#e67e22' }}>
                ...
                запросу лишь несколько секунд. Медленные пачки теперь сами делятся пополам и повторяются —
                просто продолжите импорт с сохранённой точки. Если ошибка повторяется регулярно, задайте
