...
import { IconThumbsUp, IconHeart, IconFlame, IconRocket } from "@/components/Icons";

const REACTION_ICONS = [
  { key: "like", icon: <IconThumbsUp size={16} /> },
  { key: "heart", icon: <IconHeart size={16} color="#e74c3c" /> },
  { key: "fire", icon: <IconFlame size={16} color="#e67e22" /> },
  { key: "rocket", icon: <IconRocket size={16} color="#3498db" /> },
];
