...
export async function GET(req: Request, { params }: { params: { id: string } }) {
  try {
    ...
    if (pErr || !project) {
      ...
      return NextResponse.json({ error: 'Not found', detail: pErr?.message }, { status: 404 });
    }
    ...
    return NextResponse.json({
      ...
      _debug: {
        ...
        membersError: mErr?.message ?? null,
        systemsError: sErr?.message ?? null,
        routeError: rErr?.message ?? null,
      },
    });
  } catch (e: any) {
